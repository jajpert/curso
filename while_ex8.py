"""
8 – Um funcionário de uma empresa recebe aumento salarial
...
percent = 0.015
sal = float(input("Digite o salário inicial do funcionário em 1995: "))
ano = 1995
...
print(f"O salário no ano de {ano_atual} é de R${sal:.2f}")